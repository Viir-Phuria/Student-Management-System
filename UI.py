...
class Student:
    def __init__(self,root):
        ...
        DataFrame = Frame(MainFrame, bd=1, width=1300, height=400, padx=20, pady=20, relief=RIDGE, bg="green")
...
#============================================Label and Entry Wideget==============================================================================
        ...
        self.lb1Sna= Label (DataFrameLEFT, font=('arial', 20, 'bold'),text="Surname:" ,padx=2,pady=2, bg="Ghost White")
        self.lb1Sna .grid (row=2, column=0, sticky=W)
